...
def simulate_robot_with_torque(urdf_path: str,
    ...
    for step in range(sim_steps):
        ...
        torque = amplitude * math.sin(2 * math.pi * frequency * step * time_step)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Uso: python src/simulate_with_torque.py robots/arm_bot.urdf")
        sys.exit(1)
